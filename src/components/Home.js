           ...
           <div className="container mx-auto  border border-gray-300 rounded-sm ">
                <div className="top-bar flex flex-row justify-between p-4">
                    ...
                    <div className="flex space-x-4 text-sm">
                        <button onClick={()=>{history.push('/fullscreen')}} className="flex flex-row items-center border px-4 border-gray-200 hover:shadow-lg"><i class="ri-fullscreen-exit-fill"></i> &nbsp; Full screen preview</button>
                ...
                <div className="h-96 bg-gray-200 overflow-x-auto">
                   {code ?  <Code /> : ""}
                    ...
                    <ReactSrcDocIframe srcDoc={htmlcode ? htmlcode : ""} style={{width:`${width}px`,margin:'auto',height:'100%'}}/>
